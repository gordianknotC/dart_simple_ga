...
class GoogleAnalytics implements AnalyticsSketch{
	...
	@override
  void sendPageView({String viewName, Map<String,String> parameters}) => _ga2('send', 'pageview');
	
	@override void sendEvent(String category, String action, {String label, Map<String,String> parameters, int value}) {
		assert(parameters == null && value == null, UnimplementedError("param and value are not implemented on web platform"));
		Map m = <String, String>{
			'hitType': 'event',
	...
	@override void sendTiming(String category, String variable, int valueMillis,
			{String label}) {
	...
	@override void sendException(String description, {bool fatal}) {
